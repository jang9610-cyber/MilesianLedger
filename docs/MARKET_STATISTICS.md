...
평균은 고가·저가 거래를 모두 포함합니다. 적은 수의 고가 거래가 평균을 크게 올릴 수 있으므로 일반적인 판매 가격과 다를 수 있습니다. **최근 거래가보다 저렴**은 이 평균과 최저 매물가의 차이를 정렬하는 보기라 극단적인 가격 차이가 먼저 보일 수 있습니다. 이를 수익률이나 정상 시세 판정으로 사용하지 않습니다. 평균 단가 셀의 도움말에서 거래 건수·금액 합계·판매 수량과 계산 기준을 확인할 수 있습니다.
