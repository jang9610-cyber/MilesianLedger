...
foreach ($taskSource in @('src/MarketSnapshot.cs','src/MarketSearch.cs','src/AuctionCore.cs','src/AuctionProxyConfig.cs','tests/MarketSnapshotLiveVerificationRunner.cs')) {
