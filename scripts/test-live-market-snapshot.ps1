...
foreach ($taskSource in @('src/MarketSnapshot.cs','src/MarketPricePolicy.cs','src/MarketPrices.cs','src/MarketSearch.cs','src/AuctionCore.cs','src/AuctionProxyConfig.cs','tests/MarketSnapshotLiveVerificationRunner.cs')) {
